...
const intKor = []; //Array()
const trees = ["redwood","bay","cedar","oak","qq"];
...
오른쪽의 값을 변수에 대입한다
*/
let bTitle = title1 || title2 || title3 || title4 || title5 || title6 || "우리나라";
